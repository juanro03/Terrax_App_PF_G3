...
class Tarea(models.Model):
    ...
    dosis_tipo = models.CharField(
        max_length=10,
        choices=DOSIS_TIPO_CHOICES,
        blank=True,
        default=''
    )
    ...
    mapa_adjunto = models.FileField(
        upload_to='mapas_fertilizacion/',
        blank=True,
        null=True
    )
    ...
    mapa_variable = models.FileField(
        upload_to='mapas_maleza/',
        blank=True,
        null=True
    )
