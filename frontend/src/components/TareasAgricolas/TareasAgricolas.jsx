...
export default function ActividadesAgricolas() {
  ...
  // ====== Estados por actividad (una tarea por vez) ======
  // Fertilización
  ...
  const [fert, setFert] = useState({
    ...
    hectareasAplicadas: "",
    observaciones: "",
    mapaAdjunto: null, // solo si 'variable'
  });
  ...
  // Laboreos de lote
  const [laboreo, setLaboreo] = useState({
    fecha: "",
    tipoLaboreo: "",
    operario: "",
    observaciones: "",
  ...
  // Aplicación Fitosanitaria (simple, guarda extras en observaciones)
  ...
  const handleNuevaTareaOtroLote = () => {
    limpiarFormularioActividad();
    setActividad("");
    setLote("");
    setMensaje("");
  ...
  const handleSubmit = async (e) => {
    ...
    if (!lote) {
      setMensajeOk(false);
      setMensaje("Selecciona un lote.");
      setTimeout(() => setMensaje(""), 3500);
      return;
    }

    // Construir payload según actividad
    ...
    try {
      if (actividad === "Fertilización") {
        ...
        formData.append("dosis_tipo", fertVista); // 'fija' | 'variable'
        ...
        if (fertVista === "variable" && fert.mapaAdjunto)
          formData.append("mapa_adjunto", fert.mapaAdjunto);
        ...
        if (maleza.mapaVariable)
          formData.append("mapa_variable", maleza.mapaVariable);
        ...
        formData.append("dosis_tipo", "variable"); // o controlar vista más adelante
        formData.append("plaga_maleza", fito.plaga || "");
        formData.append("producto_aplicar", fito.producto || "");

        // Extras → a observaciones
        const extras = [];
        ...
        const obs = [fito.observaciones, extras.join(" · ")]
          .filter(Boolean)
          .join(" | ");
  ...
  // habilitar submit mínimo (fecha según actividad y lote seleccionado)
  ...
  return (
    <Card
      ...
      style={{
        maxWidth: 1160, // ← restaurado al valor anterior
        background: blanco,
        borderRadius: "1.4rem",
        border: "none",
      }}
            ...
            {mensajeOk && (
              <div className="mt-2 d-flex gap-2">
                <Button
                  ...
                  onClick={handleNuevaTareaMismoLote}
                >
                  + Agregar otra tarea
                </Button>
                <Button
                  ...
                  className="rounded-pill px-3"
                  onClick={handleNuevaTareaOtroLote}
                >
                  Cambiar lote/campo
                </Button>
              </div>
              ...
              <Row className="g-3">
                <Col md={4}>
                  ...
                  <Form.Control
                    ...
                    value={fert.fecha}
                    onChange={(e) =>
                      setFert({ ...fert, fecha: e.target.value })
                    }
                  />
                </Col>
                <Col md={4}>
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setFert({ ...fert, tipoFertilizante: e.target.value })
                    }
                  />
                </Col>
                <Col md={4}>
                  ...
                  <Form.Control
                    value={fert.de}
                    onChange={(e) => setFert({ ...fert, de: e.target.value })}
                  />
                </Col>
                <Col md={4}>
                  <Form.Label>Producto a aplicar</Form.Label>
                  <Form.Control
                    value={fert.productoAplicar}
                    onChange={(e) =>
                      setFert({ ...fert, productoAplicar: e.target.value })
                    }
                  />
                </Col>
                <Col md={4}>
                  ...
                  <Form.Control
                    value={fert.concentracion}
                    onChange={(e) =>
                      setFert({ ...fert, concentracion: e.target.value })
                    }
                  />
                </Col>
                <Col md={4}>
                  ...
                  <Form.Control
                    value={fert.fabricante}
                    onChange={(e) =>
                      setFert({ ...fert, fabricante: e.target.value })
                    }
                  />
                </Col>
                <Col md={4}>
                  <Form.Label>L/Kg por Ha</Form.Label>
                  <Form.Control
                    value={fert.litrosPorHa}
                    onChange={(e) =>
                      setFert({ ...fert, litrosPorHa: e.target.value })
                    }
                  />
                </Col>
                <Col md={4}>
                  <Form.Label>Ha aplicadas</Form.Label>
                  <Form.Control
                    value={fert.hectareasAplicadas}
                    onChange={(e) =>
                      setFert({ ...fert, hectareasAplicadas: e.target.value })
                    }
                  />
                </Col>
                ...
                {fertVista === "variable" && (
                  <Col md={4}>
                    <Form.Label>Mapa adjunto</Form.Label>
                    <Form.Control
                      type="file"
                      ...
                      onChange={(e) =>
                        setFert({
                          ...fert,
                          mapaAdjunto: e.target.files?.[0] || null,
                        })
                      }
                    />
                    {fert.mapaAdjunto && (
                      <small className="text-muted">
                        {fert.mapaAdjunto.name}
                      </small>
                    )}
                  </Col>
                )}
                ...
                <Col md={12}>
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setFert({ ...fert, observaciones: e.target.value })
                    }
                  />
                </Col>
              </Row>
            ...
            <Row className="g-3">
              <Col md={4}>
                ...
                <Form.Control
                  ...
                  value={riego.fecha}
                  onChange={(e) =>
                    setRiego({ ...riego, fecha: e.target.value })
                  }
                />
              </Col>
              <Col md={4}>
                ...
                <Form.Control
                  value={riego.tipoRiego}
                  onChange={(e) =>
                    setRiego({ ...riego, tipoRiego: e.target.value })
                  }
                />
              </Col>
              <Col md={4}>
                <Form.Label>Volumen (mm)</Form.Label>
                <Form.Control
                  value={riego.volumen}
                  onChange={(e) =>
                    setRiego({ ...riego, volumen: e.target.value })
                  }
                />
              </Col>
              <Col md={12}>
                ...
                <Form.Control
                  as="textarea"
                  rows={2}
                  value={riego.observaciones}
                  onChange={(e) =>
                    setRiego({ ...riego, observaciones: e.target.value })
                  }
                />
              </Col>
            </Row>
            ...
            <Row className="g-3">
              <Col md={4}>
                ...
                <Form.Control
                  ...
                  value={laboreo.fecha}
                  onChange={(e) =>
                    setLaboreo({ ...laboreo, fecha: e.target.value })
                  }
                />
              </Col>
              <Col md={4}>
                <Form.Label>Tipo de laboreo</Form.Label>
                <Form.Select
                  value={laboreo.tipoLaboreo}
                  onChange={(e) =>
                    setLaboreo({ ...laboreo, tipoLaboreo: e.target.value })
                  }
                >
              ...
              <Col md={4}>
                ...
                <Form.Control
                  value={laboreo.operario}
                  onChange={(e) =>
                    setLaboreo({ ...laboreo, operario: e.target.value })
                  }
                />
              </Col>
              <Col md={12}>
                ...
                <Form.Control
                  as="textarea"
                  rows={2}
                  value={laboreo.observaciones}
                  onChange={(e) =>
                    setLaboreo({ ...laboreo, observaciones: e.target.value })
                  }
                />
              </Col>
            </Row>
            ...
            <Row className="g-3">
              <Col md={4}>
                ...
                <Form.Control
                  ...
                  value={maleza.fecha}
                  onChange={(e) =>
                    setMaleza({ ...maleza, fecha: e.target.value })
                  }
                />
              </Col>
              <Col md={4}>
                <Form.Label>Tipo de fitosanitarios</Form.Label>
                <Form.Control
                  value={maleza.tipoFitosanitario}
                  onChange={(e) =>
                    setMaleza({ ...maleza, tipoFitosanitario: e.target.value })
                  }
                />
              </Col>
              <Col md={4}>
                <Form.Label>Plaga / Maleza</Form.Label>
                <Form.Control
                  value={maleza.plagaMaleza}
                  onChange={(e) =>
                    setMaleza({ ...maleza, plagaMaleza: e.target.value })
                  }
                />
              </Col>
              <Col md={4}>
                <Form.Label>Producto a aplicar</Form.Label>
                <Form.Control
                  value={maleza.productoAplicar}
                  onChange={(e) =>
                    setMaleza({ ...maleza, productoAplicar: e.target.value })
                  }
                />
              </Col>
              <Col md={4}>
                <Form.Label>Fabricante</Form.Label>
                <Form.Control
                  value={maleza.fabricante}
                  onChange={(e) =>
                    setMaleza({ ...maleza, fabricante: e.target.value })
                  }
                />
              </Col>
              <Col md={4}>
                <Form.Label>L/Kg por Ha</Form.Label>
                <Form.Control
                  value={maleza.lkgPorHa}
                  onChange={(e) =>
                    setMaleza({ ...maleza, lkgPorHa: e.target.value })
                  }
                />
              </Col>
              <Col md={4}>
                <Form.Label>Ha aplicadas</Form.Label>
                <Form.Control
                  value={maleza.hectareasAplicadas}
                  onChange={(e) =>
                    setMaleza({ ...maleza, hectareasAplicadas: e.target.value })
                  }
                />
              </Col>
              <Col md={8}>
                <Form.Label>Mapa de aplicación variable</Form.Label>
                <Form.Control
                  type="file"
                  accept=".pdf,.jpg,.jpeg,.png"
                  onChange={(e) =>
                    setMaleza({
                      ...maleza,
                      mapaVariable: e.target.files?.[0] || null,
                    })
                  }
                />
                {maleza.mapaVariable && (
                  <small className="text-muted">
                    {maleza.mapaVariable.name}
                  </small>
                )}
              </Col>
              <Col md={12}>
                ...
                <Form.Control
                  as="textarea"
                  rows={2}
                  value={maleza.observaciones}
                  onChange={(e) =>
                    setMaleza({ ...maleza, observaciones: e.target.value })
                  }
                />
              </Col>
            </Row>
            ...
            <Row className="g-3">
              <Col md={4}>
                ...
                <Form.Control
                  type="date"
                  value={fito.fecha}
                  onChange={(e) => setFito({ ...fito, fecha: e.target.value })}
                />
              </Col>
              <Col md={4}>
                <Form.Label>% Afectado</Form.Label>
                <Form.Control
                  value={fito.porcentaje}
                  onChange={(e) =>
                    setFito({ ...fito, porcentaje: e.target.value })
                  }
                />
              </Col>
              <Col md={4}>
                ...
                <Form.Control
                  value={fito.plaga}
                  onChange={(e) => setFito({ ...fito, plaga: e.target.value })}
                />
              </Col>
              <Col md={4}>
                <Form.Label>Estado Fenológico</Form.Label>
                <Form.Control
                  value={fito.estadoFen}
                  onChange={(e) =>
                    setFito({ ...fito, estadoFen: e.target.value })
                  }
                />
              </Col>
              <Col md={4}>
                ...
                <Form.Control
                  value={fito.producto}
                  onChange={(e) =>
                    setFito({ ...fito, producto: e.target.value })
                  }
                />
              </Col>
              <Col md={4}>
                ...
                <Form.Control
                  value={fito.maquinaria}
                  onChange={(e) =>
                    setFito({ ...fito, maquinaria: e.target.value })
                  }
                />
              </Col>
              <Col md={4} className="d-flex align-items-end">
                <Form.Check
                  ...
                  label="Incluye mapa"
                  checked={!!fito.mapa}
                  onChange={(e) => setFito({ ...fito, mapa: e.target.checked })}
                />
              </Col>
              <Col md={12}>
                <Form.Label>Observaciones</Form.Label>
